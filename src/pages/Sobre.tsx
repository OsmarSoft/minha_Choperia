...
const Sobre = () => {
  ...
  return (
    <div className="bg-brewery-cream pt-16">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-brewery-dark">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Visite nossa cervejaria, participe de degustações ou apenas venha tomar uma cerveja com a gente. Estamos sempre de portas abertas para os amantes de boa cerveja.
          </motion.p>
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
